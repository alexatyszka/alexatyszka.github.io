...
```{r fig1a, echo=FALSE, warning=FALSE, , out.width='100%'}
...
ggplotly(p)%>% config(displayModeBar = T, scrollZoom =F)%>% layout(dragmode="pan"
      )
```
...
```{r fig1b, echo=FALSE, echo=FALSE, warning=FALSE, out.width='100%', fig.height=6}
...
ggplotly(p)%>% config(displayModeBar = F, scrollZoom =F)%>% layout(dragmode="pan"
      )
```
...
```{r fig1c, echo=FALSE, echo=FALSE, warning=FALSE, out.width='100%', fig.height=6}
