...
<nav class="supp-nav">
  ...
  <span style="font-family: var(--font-sans); color: #666; font-size: 0.875rem;"
    >PAGE TITLE HERE</span
  >
</nav>
```
...
- **Species:** _Guzmania lingulata_ (Bromeliaceae) — a Caribbean bromeliad directly relevant to the research
...
- **Attribution (required):** _Guzmania lingulata_ (Bromeliaceae) · Photo: Wikimedia Commons, CC BY-SA 3.0
